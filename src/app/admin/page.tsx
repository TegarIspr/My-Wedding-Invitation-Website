...
export default function Admin() {
  const [user, setUser] = useState<User | null>(null); // If null, the Admin is logged out
  ...
  const [guests, setGuests] = useState<Record<string, unknown>[]>([]); // Initialise an empty array to sto the guests list
